<!--
Vendored copy of the Binary Studio Academy JavaScript quality criteria.

Source: https://github.com/BinaryStudioAcademy/quality-criteria/blob/production/src/javascript.md

Re-sync with:
  curl -sSL -o docs/quality-criteria.md https://raw.githubusercontent.com/BinaryStudioAcademy/quality-criteria/production/src/javascript.md
(then re-add this comment block)

It is checked in rather than fetched at review time so the pull request review reads
a fixed, reviewable ruleset instead of spending a turn on the network every run.
-->
